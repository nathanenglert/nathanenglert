			...
			<footer className="footer has-background-dark has-text-grey-light">
				<div className="content has-text-centered">					
					<p className="">
						...
						<a className="button is-medium is-dark" href={data.site.siteMetadata.instagram} target="_blank" rel="noopener noreferrer">
							<span className="icon is-small">							
								<FaInstagram />							
							</span>
						</a>
						...
						<a className="button is-medium is-dark" href={data.site.siteMetadata.devto} target="_blank" rel="noopener noreferrer">
							<span className="icon is-small">							
								<FaDev />							
							</span>
						</a>
						<a className="button is-medium is-dark" href={data.site.siteMetadata.linkedin} target="_blank" rel="noopener noreferrer">
							<span className="icon is-small">							
								<FaLinkedin />							
							</span>
						</a>
